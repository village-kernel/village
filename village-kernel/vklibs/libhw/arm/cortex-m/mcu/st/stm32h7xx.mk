...
# link script
LDSCRIPT-KERNEL-$(CONFIG_STM32H750VB) := -T village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32H7xx_lds/STM32H750VB_flash.ld
...
# paths
######################################
inc-$(CONFIG_STM32H7xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/CMSIS/Device/STM32H7xx/Include
src-$(CONFIG_STM32H7xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/CMSIS/Device/STM32H7xx/Source

ifeq ($(CONFIG_MANUFACTURER_HAL_DRIVER), y)
inc-$(CONFIG_STM32H7xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32H7xx_HAL_Driver/Inc
inc-$(CONFIG_STM32H7xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32H7xx_HAL_Driver/Inc/Legacy
src-$(CONFIG_STM32H7xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32H7xx_HAL_Driver/Src
endif
...
ifeq ($(CONFIG_MANUFACTURER_HAL_DRIVER), y)
-include village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32H7xx_HAL_Driver/Makefile
endif
