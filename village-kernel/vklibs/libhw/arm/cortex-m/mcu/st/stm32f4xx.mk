...
# link script
LDSCRIPT-KERNEL-$(CONFIG_STM32F405RG) := -T village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_lds/STM32F405RG_flash.ld
LDSCRIPT-KERNEL-$(CONFIG_STM32F407ZE) := -T village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_lds/STM32F407ZE_flash.ld
LDSCRIPT-KERNEL-$(CONFIG_STM32F407ZG) := -T village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_lds/STM32F407ZG_flash.ld
...
# paths
######################################
inc-$(CONFIG_STM32F4xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/CMSIS/Device/STM32F4xx/Include
src-$(CONFIG_STM32F4xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/CMSIS/Device/STM32F4xx/Source

ifeq ($(CONFIG_MANUFACTURER_HAL_DRIVER), y)
inc-$(CONFIG_STM32F4xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_HAL_Driver/Inc
inc-$(CONFIG_STM32F4xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_HAL_Driver/Inc/Legacy
src-$(CONFIG_STM32F4xx) += village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_HAL_Driver/Src
endif
...
ifeq ($(CONFIG_MANUFACTURER_HAL_DRIVER), y)
-include village-kernel/vklibs/libhw/arm/cortex-m/mcu/st/STM32F4xx_HAL_Driver/Makefile
endif
