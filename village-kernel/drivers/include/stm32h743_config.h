...
{                                                                         \
	...
	.deGpio = { 0, 0, 0, 0, 0 },                                          \
                                                                          \
	.txDma = { Dma::_Group1, Dma::_Stream3, 42, NULL, Dma::_MemoryToPeriph },\
	.rxDma = { Dma::_Group1, Dma::_Stream2, 41, NULL, Dma::_PeriphToMemory },\
}
...
{                                                                         \
	.spiCh    = Spi::_Spi5,                                               \
                                                                          \
	.sckGpio  = { Gpio::_ChF, 7,  Gpio::_Altera, 5, 0 },                  \
	.misoGpio = { Gpio::_ChF, 8,  Gpio::_Altera, 5, 0 },                  \
	.mosiGpio = { Gpio::_ChF, 9,  Gpio::_Altera, 5, 0 },                  \
