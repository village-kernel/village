...
/// @brief Returns the priority group setting, which indicates 
///        the number of bits used for the group priority and subpriority.
/// @return 
...
/// @brief Configures the priority group setting, which determines
///        the number of bits used for the group priority and subpriority.
/// @param prioGroup 
